...
hljs.registerLanguage("blech",function(e){var t={keyword:"abort activity and await blech cobegin const do else elseif end extern function if let not or param repeat run reset return returns singleton struct then until var weak when while with",built_in:"bits8 bits16 bits32 bits64 bool float32 float64 int8 int16 int32 int64 nat8 nat16 nat32 nat64 prev",literal:"false true"},r={cN:"type",b:"\\b[A-Z][\\w']*",r:0},a=e.C("/\\*","\\*/",{c:["self"]}),n={cN:"subst",b:/\\\(/,e:"\\)",k:t,c:[]},i={cN:"number",r:0,v:[{b:e.CNR+"[0-9A-Za-z$_]*"}]},s=e.inherit(e.QSM,{c:[n,e.BE]});return n.c=[i],{k:t,c:[s,e.CLCM,a,r,i,{cN:"meta",b:/@[A-Za-z$_][0-9A-Za-z$_]*/,e:/\(/,eE:!0},{bK:"import",e:/$/,c:[e.CLCM,a]}]}});
